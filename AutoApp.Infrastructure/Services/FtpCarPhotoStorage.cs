...
/// <summary>
/// Car photo storage implementation using FTP or FTPS protocols.
/// </summary>
public class FtpCarPhotoStorage(IOptions<CarPhotoStorageOptions> options) : ICarPhotoStorage
{
    private readonly CarPhotoStorageOptions _options = options.Value;

    public async Task<string> UploadAsync(Guid carPhotoId, Stream content, string originalFileName, CancellationToken ct)
    {
        ...
        var fileName = $"{carPhotoId:N}{extension.ToLowerInvariant()}";
